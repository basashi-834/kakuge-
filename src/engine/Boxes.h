...
// 立ち姿の外形は 幅 32 x 高さ 95。見た目の幅（約 52）よりわざと細く
...
struct HurtboxSet {
    ...
    //   脚 [-45, 0] / 胴 [-77, -45] / 頭 [-95, -77]
    std::vector<HurtboxPart> Stand{
        {"head",  RectBox{0, -86, 19, 18}},
        {"torso", RectBox{0, -61, 32, 32}},
        {"leg",   RectBox{0, -22.5, 30, 45}},
    };
    // しゃがみ: 全体で 62 の高さ。立ち（95）よりぐっと低いので、
    // 上を通る攻撃（中段）をかわせます。
    // 頭は胴に 6 だけ食い込ませています（首をすくめた姿勢の表現）。
    std::vector<HurtboxPart> Crouch{
        {"head",  RectBox{0, -54, 19, 16}},
        {"torso", RectBox{0, -39, 32, 26}},
        {"leg",   RectBox{0, -13, 37, 26}},
    };
    // 空中: 脚を抱え込む姿勢なので、立ちより一回り小さい 78 の高さ。
    std::vector<HurtboxPart> Air{
        {"head",  RectBox{0, -69, 19, 18}},
        {"torso", RectBox{0, -45, 30, 30}},
        {"leg",   RectBox{0, -15, 26, 30}},
    };
